...
三、使用 imp_level1_category_1d + SEO 搜索关键词字符 进行训练的总体结果如下（模型结构 3）:
数据集说明:

![数据集](https://p.ipic.vip/xnzym7.png)
训练集和测试集的划分:
1. 去除 Keyword, Category 空的行
2. 删除重复的 Keyword 行
3. 划分训练集和测试集
```
...
| 模型名称 | sg | my | th | tw | vn | id | ph | br | mx | cl | co |  
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | 
| 模型复现 | 80%|79%|60%|73%|70%|71%|80%|73%|67%|70%|69%|
| 字符+imp | 78.63%|77.23%|67.05%|75.59%|70.39%|69.99%|79.42%|71.20%|62.58%|65.02%|62.17%|
