...
if __name__ == '__main__':
    ...
    model = RNNModel(n_letters, n_hidden, n_classes)
    model.load_state_dict(torch.load('names.classify'))
    ...
    # Set up axes
    ax.set_xticklabels([''] + dataset.label_name, rotation=90)
    ax.set_yticklabels([''] + dataset.label_name)
