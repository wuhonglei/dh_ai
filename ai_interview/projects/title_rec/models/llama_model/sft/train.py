...
from config import train_csv_path, test_csv_path, name_col, label_id_col, label_names_csv_path
...
def build_dataloader(csv_path: str, tokenizer: PreTrainedTokenizer | PreTrainedTokenizerFast, name_col: str, label_id_col: str, id_to_name: dict[int, str], label_names: list[str]):
    dataset = TitleRecDataset(
        csv_path, tokenizer, name_col, label_id_col, id_to_name, label_names)
...
train_dataloader = build_dataloader(
    train_csv_path, tokenizer, name_col, label_id_col, id_to_name, label_names)
test_dataloader = build_dataloader(
    test_csv_path, tokenizer, name_col, label_id_col, id_to_name, label_names)
