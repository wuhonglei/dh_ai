...
class TitleRecDataset(Dataset):
    def __init__(self, csv_path: str, tokenizer: PreTrainedTokenizer | PreTrainedTokenizerFast, name_col: str, label_id_col: str, id_to_name: dict[int, str], label_names: list[str]):
    ...
    def __getitem__(self, idx):
        ...
        prompt = f'Text: "{name}"\nWhich category? [{", ".join(self.label_names)}]\nAnswer:'
        return {
